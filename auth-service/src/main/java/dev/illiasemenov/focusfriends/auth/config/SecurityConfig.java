    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // внутренний вызов от gateway — свой механизм проверки (X-Api-Token), не JWT
                        .requestMatchers("/api/auth/api-tokens/validate").permitAll()
                        .requestMatchers("/api/auth/api-tokens/**").authenticated()
